...
const {dialog, ipcMain, Menu, Tray} = require('electron')


function buildTrayMenu(addresses, provisionedId, callback) {
    const menu = new Menu()
...
let template = [
    {
        ...
        submenu: [
            ...
            },
            {
                label: 'RED',
                click: function () {
                    electron.shell.openItem(app.getAppPath() + '/electron-node-red/dist/mac/RED.app')
                }
        ...
        submenu: [
            ...
            },
            {
                ...
                click: function () {
                    ...
                    mainWindow.loadURL('http://localhost:8088/app')
